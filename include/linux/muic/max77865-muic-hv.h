/*
 * max77865-muic-hv.h - MUIC for the Maxim 77843
 *
 ...
 *
 * This driver is based on max77865-muic.h
 *
 */
...
#define MUIC_HV_DEV_NAME		"muic-max77865-hv"
...
#define INTMASK3_VBADCM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_VBADCM_SHIFT)
#define INTMASK3_VDNMONM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_VDNMONM_SHIFT)
#define INTMASK3_DNRESM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_DNRESM_SHIFT)
#define INTMASK3_MPNACKM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_MPNACKM_SHIFT)
#define INTMASK3_MRXBUFOWM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_MRXBUFOWM_SHIFT)
#define INTMASK3_MRXTRFM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_MRXTRFM_SHIFT)
#define INTMASK3_MRXPERRM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_MRXPERRM_SHIFT)
#define INTMASK3_MRXRDYM_MASK		(MAX77865_ENABLE_BIT << INTMASK3_MRXRDYM_SHIFT)

/* MAX77865 HVCONTROL1 register */
...
enum max77865_reg_hv_val {
	MAX77865_MUIC_HVCONTROL1_DPVD_06	= (0x2 << HVCONTROL1_DPVD_SHIFT),
	MAX77865_MUIC_HVCONTROL1_11	= (MAX77865_MUIC_HVCONTROL1_DPVD_06 | \
					HVCONTROL1_DPDNVDEN_MASK),
	MAX77865_MUIC_HVCONTROL1_31	= (HVCONTROL1_VBUSADCEN_MASK | \
					MAX77865_MUIC_HVCONTROL1_DPVD_06 | \
					HVCONTROL1_DPDNVDEN_MASK),
	MAX77865_MUIC_HVCONTROL2_06	= (HVCONTROL2_DP06EN_MASK | HVCONTROL2_DNRESEN_MASK),
	MAX77865_MUIC_HVCONTROL2_13	= (HVCONTROL2_MTXEN_MASK | HVCONTROL2_DP06EN_MASK | \
					HVCONTROL2_HVDIGEN_MASK),
	MAX77865_MUIC_HVCONTROL2_1B	= (HVCONTROL2_HVDIGEN_MASK | HVCONTROL2_DP06EN_MASK | \
					HVCONTROL2_MPING_MASK | HVCONTROL2_MTXEN_MASK),
	MAX77865_MUIC_HVCONTROL2_1F	= (HVCONTROL2_HVDIGEN_MASK | HVCONTROL2_DP06EN_MASK | \
					HVCONTROL2_DNRESEN_MASK | HVCONTROL2_MPING_MASK | HVCONTROL2_MTXEN_MASK),
	MAX77865_MUIC_HVCONTROL2_5B	= (HVCONTROL2_HVDIGEN_MASK | HVCONTROL2_DP06EN_MASK | \
					HVCONTROL2_MPING_MASK | HVCONTROL2_MTXEN_MASK | HVCONTROL2_MPNGENB_MASK),
	MAX77865_MUIC_INTMASK3_FB	= (INTMASK3_MRXRDYM_MASK | INTMASK3_MRXPERRM_MASK | \
					INTMASK3_MRXTRFM_MASK | INTMASK3_MRXBUFOWM_MASK | \
					INTMASK3_MPNACKM_MASK | INTMASK3_VDNMONM_MASK | \
					INTMASK3_VBADCM_MASK),
};

extern bool muic_check_dev_ta(struct max77865_muic_data *muic_data);
extern bool muic_check_is_hv_dev(struct max77865_muic_data *muic_data);
extern muic_attached_dev_t hv_muic_check_id_err
	(struct max77865_muic_data *muic_data, muic_attached_dev_t new_dev);

extern void max77865_hv_muic_reset_hvcontrol_reg(struct max77865_muic_data *muic_data);
#if defined(CONFIG_OF)
extern int of_max77865_hv_muic_dt(struct max77865_muic_data *muic_data);
#endif

extern int max77865_afc_muic_irq_init(struct max77865_muic_data *muic_data);
extern void max77865_hv_muic_free_irqs(struct max77865_muic_data *muic_data);

extern int max77865_muic_hv_update_reg(struct i2c_client *i2c,
		const u8 reg, const u8 val, const u8 mask, const bool debug_en);
extern void max77865_muic_set_afc_ready(struct max77865_muic_data *muic_data, bool value);

extern void max77865_hv_muic_init_check_dpdnvden (struct max77865_muic_data *muic_data);
extern void max77865_hv_muic_init_detect(struct max77865_muic_data *muic_data);
extern void max77865_hv_muic_initialize(struct max77865_muic_data *muic_data);
extern void max77865_hv_muic_remove(struct max77865_muic_data *muic_data);
extern void max77865_hv_muic_remove_wo_free_irq(struct max77865_muic_data *muic_data);

extern void max77865_muic_set_adcmode_always(struct max77865_muic_data *muic_data);
#if !defined(CONFIG_SEC_FACTORY)
extern void max77865_muic_set_adcmode_oneshot(struct max77865_muic_data *muic_data);
#endif /* !CONFIG_SEC_FACTORY */
extern void max77865_hv_muic_adcmode_oneshot(struct max77865_muic_data *muic_data);

extern void max77865_muic_prepare_afc_charger(struct max77865_muic_data *muic_data);
