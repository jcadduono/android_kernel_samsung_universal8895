#!/bin/bash
# Android kernel for Samsung Exynos 8895 devices build script by jcadduono
...
# root directory of Samsung Universal8895 git repo (default is this script's location)
RDIR=$(pwd)
