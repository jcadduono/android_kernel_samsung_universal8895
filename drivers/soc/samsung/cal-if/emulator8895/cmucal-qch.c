...
unsigned int cmucal_qch_size = 554;
...
struct cmucal_qch cmucal_qch_list[] = {
	...
	CLK_QCH(MMC_CARD1_QCH, QCH_CON_MMC_CARD1_QCH_ENABLE, QCH_CON_MMC_CARD1_QCH_CLOCK_REQ, QCH_CON_MMC_CARD1_QCH_EXPIRE_VAL),
	...
	CLK_QCH(PCIE0_QCH_PCIE0_MSTR, QCH_CON_PCIE0_QCH_PCIE0_MSTR_ENABLE, QCH_CON_PCIE0_QCH_PCIE0_MSTR_CLOCK_REQ, QCH_CON_PCIE0_QCH_PCIE0_MSTR_EXPIRE_VAL),
	CLK_QCH(PCIE0_QCH_PCIE0_PHY, QCH_CON_PCIE0_QCH_PCIE0_PHY_ENABLE, QCH_CON_PCIE0_QCH_PCIE0_PHY_CLOCK_REQ, QCH_CON_PCIE0_QCH_PCIE0_PHY_EXPIRE_VAL),
	CLK_QCH(PCIE0_QCH_PCIE0_DBI, QCH_CON_PCIE0_QCH_PCIE0_DBI_ENABLE, QCH_CON_PCIE0_QCH_PCIE0_DBI_CLOCK_REQ, QCH_CON_PCIE0_QCH_PCIE0_DBI_EXPIRE_VAL),
	CLK_QCH(PCIE0_QCH_PCIE0_APB, QCH_CON_PCIE0_QCH_PCIE0_APB_ENABLE, QCH_CON_PCIE0_QCH_PCIE0_APB_CLOCK_REQ, QCH_CON_PCIE0_QCH_PCIE0_APB_EXPIRE_VAL),
	CLK_QCH(PCIE0_QCH_PCIE0_PCS, QCH_CON_PCIE0_QCH_PCIE0_PCS_ENABLE, QCH_CON_PCIE0_QCH_PCIE0_PCS_CLOCK_REQ, QCH_CON_PCIE0_QCH_PCIE0_PCS_EXPIRE_VAL),
	CLK_QCH(PCIE0_QCH_PCIE0_SOCPLL, DMYQCH_CON_PCIE0_QCH_PCIE0_SOCPLL_ENABLE, DMYQCH_CON_PCIE0_QCH_PCIE0_SOCPLL_CLOCK_REQ, EMPTY_CAL_ID),
	CLK_QCH(PCIE1_QCH_PCIE1_MSTR, QCH_CON_PCIE1_QCH_PCIE1_MSTR_ENABLE, QCH_CON_PCIE1_QCH_PCIE1_MSTR_CLOCK_REQ, QCH_CON_PCIE1_QCH_PCIE1_MSTR_EXPIRE_VAL),
	CLK_QCH(PCIE1_QCH_PCIE1_PHY, QCH_CON_PCIE1_QCH_PCIE1_PHY_ENABLE, QCH_CON_PCIE1_QCH_PCIE1_PHY_CLOCK_REQ, QCH_CON_PCIE1_QCH_PCIE1_PHY_EXPIRE_VAL),
	CLK_QCH(PCIE1_QCH_PCIE1_DBI, QCH_CON_PCIE1_QCH_PCIE1_DBI_ENABLE, QCH_CON_PCIE1_QCH_PCIE1_DBI_CLOCK_REQ, QCH_CON_PCIE1_QCH_PCIE1_DBI_EXPIRE_VAL),
	CLK_QCH(PCIE1_QCH_PCIE1_APB, QCH_CON_PCIE1_QCH_PCIE1_APB_ENABLE, QCH_CON_PCIE1_QCH_PCIE1_APB_CLOCK_REQ, QCH_CON_PCIE1_QCH_PCIE1_APB_EXPIRE_VAL),
	CLK_QCH(PCIE1_QCH_PCIE1_PCS, QCH_CON_PCIE1_QCH_PCIE1_PCS_ENABLE, QCH_CON_PCIE1_QCH_PCIE1_PCS_CLOCK_REQ, QCH_CON_PCIE1_QCH_PCIE1_PCS_EXPIRE_VAL),
	CLK_QCH(PCIE1_QCH_PCIE1_OSCPLL, DMYQCH_CON_PCIE1_QCH_PCIE1_OSCPLL_ENABLE, DMYQCH_CON_PCIE1_QCH_PCIE1_OSCPLL_CLOCK_REQ, EMPTY_CAL_ID),
