...
struct cmucal_pll_table pll_mif_rate_table[] = {
	...
	PLL_RATE_MPS(2576599854, 247, 5, 1),
	PLL_RATE_MPS(1865500000, 287, 4, 0),
	PLL_RATE_MPS(1418000000, 333, 13, 0),
};
...
struct cmucal_pll_table pll_g3d_rate_table[] = {
	PLL_RATE_MPS(860000000, 400, 13, 0),
	PLL_RATE_MPS(600000000, 300, 13, 0),
	PLL_RATE_MPS(300000000, 400, 13, 1),
};

struct cmucal_pll_table pll_cpucl0_rate_table[] = {
	PLL_RATE_MPS(2660666748, 394, 4, 0),
	PLL_RATE_MPS(2158000000, 327, 4, 0),
	PLL_RATE_MPS(1698666748, 189, 3, 0),
	PLL_RATE_MPS(1066000000, 231, 3, 1),
	PLL_RATE_MPS(400833344, 185, 3, 2),
};

struct cmucal_pll_table pll_cpucl1_rate_table[] = {
	PLL_RATE_MPS(1800500000, 369, 6, 0),
	PLL_RATE_MPS(1449500000, 311, 6, 0),
	PLL_RATE_MPS(1046500000, 231, 6, 0),
	PLL_RATE_MPS(600000000, 277, 6, 1),
	PLL_RATE_MPS(300000000, 355, 6, 2),
};
...
enum clk_id cmucal_mux_s14_clkcmu_fsys0_mmc_card1_parents[] = {
	OSCCLK_CMU,
	PLL_SHARED2,
	PLL_SHARED4,
	DIV_PLL_SHARED0_DIV4,
...
enum clk_id cmucal_mux_s14_clkcmu_fsys0_mmc_card1_user_parents[] = {
	OSCCLK_FSYS0,
...
/*====================The section of MUXs===================*/
unsigned int cmucal_mux_size = 222;
...
struct cmucal_mux cmucal_mux_list[] = {
	...
	CLK_MUX(MUX_S14_CLKCMU_FSYS0_MMC_CARD1, cmucal_mux_s14_clkcmu_fsys0_mmc_card1_parents, CLK_CON_MUX_MUX_S14_CLKCMU_FSYS0_MMC_CARD1_SELECT, CLK_CON_MUX_MUX_S14_CLKCMU_FSYS0_MMC_CARD1_BUSY, CLK_CON_MUX_MUX_S14_CLKCMU_FSYS0_MMC_CARD1_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_MUX(MUX_S14_CLKCMU_FSYS0_MMC_CARD1_USER, cmucal_mux_s14_clkcmu_fsys0_mmc_card1_user_parents, PLL_CON0_MUX_S14_CLKCMU_FSYS0_MMC_CARD1_USER_MUX_SEL, PLL_CON0_MUX_S14_CLKCMU_FSYS0_MMC_CARD1_USER_BUSY, PLL_CON2_MUX_S14_CLKCMU_FSYS0_MMC_CARD1_USER_ENABLE_AUTOMATIC_CLKGATING),
...
/*====================The section of DIVs===================*/
unsigned int cmucal_div_size = 123;
...
struct cmucal_div cmucal_div_list[] = {
	...
	CLK_DIV(S14_CLKCMU_FSYS0_MMC_CARD1, GATE_S14_CLKCMU_FSYS0_MMC_CARD1, CLK_CON_DIV_S14_CLKCMU_FSYS0_MMC_CARD1_DIVRATIO, CLK_CON_DIV_S14_CLKCMU_FSYS0_MMC_CARD1_BUSY, CLK_CON_DIV_S14_CLKCMU_FSYS0_MMC_CARD1_ENABLE_AUTOMATIC_CLKGATING),
...
unsigned int cmucal_gate_size = 1049;
...
struct cmucal_gate cmucal_gate_list[] = {
	...
	CLK_GATE(GATE_S14_CLKCMU_FSYS0_MMC_CARD1, MUX_S14_CLKCMU_FSYS0_MMC_CARD1, CLK_CON_GAT_GATE_S14_CLKCMU_FSYS0_MMC_CARD1_CG_VAL, CLK_CON_GAT_GATE_S14_CLKCMU_FSYS0_MMC_CARD1_MANUAL, CLK_CON_GAT_GATE_S14_CLKCMU_FSYS0_MMC_CARD1_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_I_ACLK, MUX_CLKCMU_FSYS0_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_I_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_I_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_I_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_SDCLKIN, MUX_S14_CLKCMU_FSYS0_MMC_CARD1_USER, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_SDCLKIN_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_SDCLKIN_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_CARD1_IPCLKPORT_SDCLKIN_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USB20DRD_ACLK, MUX_CLKCMU_FSYS0_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USB20DRD_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USB20DRD_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USB20DRD_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	...
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_combo_phy_1lane_test_wrapper_inst_0_I_COMBO_PHY__SCL_APB_PCLK, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_COMBO_PHY_1LANE_TEST_WRAPPER_INST_0_I_COMBO_PHY__SCL_APB_PCLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_COMBO_PHY_1LANE_TEST_WRAPPER_INST_0_I_COMBO_PHY__SCL_APB_PCLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_COMBO_PHY_1LANE_TEST_WRAPPER_INST_0_I_COMBO_PHY__SCL_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_dbi_aclk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_DBI_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_DBI_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_DBI_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_mstr_aclk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_MSTR_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_MSTR_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_MSTR_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_pcie_sub_ctrl_inst_0_i_driver_apb_clk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_FSYS1_UID_PCIE0_IPCLKPORT_phy_refclk_in, MUX_CLKCMU_FSYS1_PCIE_USER, CLK_CON_GAT_CLK_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PHY_REFCLK_IN_CG_VAL, CLK_CON_GAT_CLK_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PHY_REFCLK_IN_MANUAL, CLK_CON_GAT_CLK_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PHY_REFCLK_IN_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_pipe4_digital_x1_wrap_inst_0_i_apb_pclk_scl, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PIPE4_DIGITAL_X1_WRAP_INST_0_I_APB_PCLK_SCL_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PIPE4_DIGITAL_X1_WRAP_INST_0_I_APB_PCLK_SCL_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_PIPE4_DIGITAL_X1_WRAP_INST_0_I_APB_PCLK_SCL_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_slv_aclk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_SLV_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_SLV_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE0_IPCLKPORT_SLV_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_combo_phy_1lane_test_wrapper_inst_0_I_COMBO_PHY__SCL_APB_PCLK, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_COMBO_PHY_1LANE_TEST_WRAPPER_INST_0_I_COMBO_PHY__SCL_APB_PCLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_COMBO_PHY_1LANE_TEST_WRAPPER_INST_0_I_COMBO_PHY__SCL_APB_PCLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_COMBO_PHY_1LANE_TEST_WRAPPER_INST_0_I_COMBO_PHY__SCL_APB_PCLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_dbi_aclk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_DBI_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_DBI_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_DBI_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_mstr_aclk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_MSTR_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_MSTR_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_MSTR_ACLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_pcie_sub_ctrl_inst_0_i_driver_apb_clk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(CLK_BLK_FSYS1_UID_PCIE1_IPCLKPORT_phy_refclk_in, MUX_CLKCMU_FSYS1_PCIE_USER, CLK_CON_GAT_CLK_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PHY_REFCLK_IN_CG_VAL, CLK_CON_GAT_CLK_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PHY_REFCLK_IN_MANUAL, CLK_CON_GAT_CLK_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PHY_REFCLK_IN_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_pipe4_digital_x1_wrap_inst_0_i_apb_pclk_scl, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PIPE4_DIGITAL_X1_WRAP_INST_0_I_APB_PCLK_SCL_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PIPE4_DIGITAL_X1_WRAP_INST_0_I_APB_PCLK_SCL_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_PIPE4_DIGITAL_X1_WRAP_INST_0_I_APB_PCLK_SCL_ENABLE_AUTOMATIC_CLKGATING),
	CLK_GATE(GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_slv_aclk, MUX_CLKCMU_FSYS1_BUS_USER, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_SLV_ACLK_CG_VAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_SLV_ACLK_MANUAL, CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE1_IPCLKPORT_SLV_ACLK_ENABLE_AUTOMATIC_CLKGATING),
