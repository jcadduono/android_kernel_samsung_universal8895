...
#endif
	[DD_SEL_MAPTBL] = DEFINE_2D_MAPTBL(vkc_a2_da_dd_sel_table, init_common_table, getidx_dd_sel_table, copy_common_maptbl),
...
u8 VKC_A2_DA_MIC[] = { 0xF9, 0x03 };
u8 VKC_A2_DA_SCALER[] = { 0xBA, 0x02 };
u8 VKC_A2_DA_TE_ON[] = { 0x35, 0x00 };
u8 VKC_A2_DA_TE_OFF[] = { 0x34 };
u8 VKC_A2_DA_TSP_TE[] = { 0xBC, 0x11, 0x11, 0x02, 0x16, 0x02, 0x16 };
u8 VKC_A2_DA_ERR_FG[] = { 0xED, 0x44 };
u8 VKC_A2_DA_TE_START[] = { 0xB9, 0x01, 0x09, 0xFF, 0x00, 0x09 };
u8 VKC_A2_DA_PENTILE_CONTROL[] = {
	0xC2,
...
u8 VKC_A2_DA_TSET_00[] = { 0xB0, 0x1C };
u8 VKC_A2_DA_TSET_01[] = { 0xB5, 0x19 }; /* temperature 25 */
u8 VKC_A2_DA_MPS_ELVSS[] = {
	0xB5,
	0xBC,	/* MPS_CON: ACL OFF */
	0x0A,	/* ELVSS: MAX*/
};
u8 VKC_A2_DA_ELVSS_TEMP_00[] = { 0xB0, 0x15 };
u8 VKC_A2_DA_ELVSS_TEMP_01[] = { 0xB5, 0x10 };
u8 VKC_A2_DA_VINT[] = {
	0xF4,
	0xAB,                   /* VINT */
	0x1E                    /* 360nit */
...
u8 VKC_A2_DA_STAND_ALONE[] = { 0xF2, 0x47 };
u8 VKC_A2_DA_DD_SEL[] = { 0xF2, 0x47 };
u8 VKC_A2_DA_CASET[] = { 0x2A, 0x00, 0x3C, 0x04, 0x73, 0x00, 0x0A, 0x0A };
u8 VKC_A2_DA_PASET[] = { 0x2B, 0x00, 0x00, 0x07, 0x7F };
...
DEFINE_STATIC_PACKET(vkc_a2_da_stand_alone, DSI_PKT_TYPE_WR, VKC_A2_DA_STAND_ALONE);
DEFINE_VARIABLE_PACKET(vkc_a2_da_dd_sel, DSI_PKT_TYPE_WR, VKC_A2_DA_DD_SEL, &vkc_a2_da_maptbl[DD_SEL_MAPTBL], 1);
...
DEFINE_STATIC_PACKET(vkc_a2_da_err_fg, DSI_PKT_TYPE_WR, VKC_A2_DA_ERR_FG);
DEFINE_STATIC_PACKET(vkc_a2_da_te_start, DSI_PKT_TYPE_WR, VKC_A2_DA_TE_START);
DEFINE_STATIC_PACKET(vkc_a2_da_pentile_control, DSI_PKT_TYPE_WR, VKC_A2_DA_PENTILE_CONTROL);

DEFINE_STATIC_PACKET(vkc_a2_da_mic, DSI_PKT_TYPE_WR, VKC_A2_DA_MIC);
...
DEFINE_VARIABLE_PACKET(vkc_a2_da_aor, DSI_PKT_TYPE_WR, VKC_A2_DA_AOR, &vkc_a2_da_maptbl[AOR_MAPTBL], 9);

DEFINE_STATIC_PACKET(vkc_a2_da_tset_00, DSI_PKT_TYPE_WR, VKC_A2_DA_TSET_00);
DEFINE_VARIABLE_PACKET(vkc_a2_da_tset_01, DSI_PKT_TYPE_WR, VKC_A2_DA_TSET_01, &vkc_a2_da_maptbl[TSET_MAPTBL], 1);

static struct pkt_update_info  PKTUI(vkc_a2_da_mps_elvss)[] = {
	{ .offset = 1, .maptbl = &vkc_a2_da_maptbl[MPS_MAPTBL] },
	{ .offset = 2, .maptbl = &vkc_a2_da_maptbl[ELVSS_MAPTBL] },
};
static DEFINE_PACKET(vkc_a2_da_mps_elvss, DSI_PKT_TYPE_WR, VKC_A2_DA_MPS_ELVSS,
		PKTUI(vkc_a2_da_mps_elvss), ARRAY_SIZE(PKTUI(vkc_a2_da_mps_elvss)));

DEFINE_STATIC_PACKET(vkc_a2_da_elvss_temp_00, DSI_PKT_TYPE_WR, VKC_A2_DA_ELVSS_TEMP_00);
DEFINE_VARIABLE_PACKET(vkc_a2_da_elvss_temp_01, DSI_PKT_TYPE_WR, VKC_A2_DA_ELVSS_TEMP_01, &vkc_a2_da_maptbl[ELVSS_TEMP_MAPTBL], 1);
...
struct common_panel_info s6e3hf3_vkc_a2_da_default_panel_info = {
	.ldi_name = "s6e3hf3",
	...
	.copr_data = &s6e3hf3_vkc_a2_da_copr_data,
#endif
};
