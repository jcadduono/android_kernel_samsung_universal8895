 ...
 * context)
 */
#define DEFAULT_JS_SOFT_STOP_TICKS       (4) /* 100ms-200ms -> 200ms */

/*
 * Default minimum number of scheduling ticks before CL jobs are soft-stopped.
 */
#define DEFAULT_JS_SOFT_STOP_TICKS_CL    (4) /* 100ms-200ms -> 200ms */
 ...
 */
#define DEFAULT_JS_SOFT_JOB_TIMEOUT ((u32)1000) /* 3s -> 1s */
